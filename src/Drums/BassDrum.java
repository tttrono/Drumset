...
//	double scale_y;
//	
//	ArrayList<Rectangle> drumbody;
//	ArrayList<Line2D.Double> lugsandpegs;
//
//	/** The BassDrum constructor sets an initial scale of 1. 
//	 *  Initializes the drum body and kick pedal. */
//	public BassDrum() {
...
//		scale_y = 1.0;
//		
//		drumbody = new ArrayList<Rectangle>();
//		lugsandpegs = new ArrayList<Line2D.Double>();
// 	}
//	
//	/** Draws the bass drum graphic plus pedal. */
//	public void draw(Graphics2D g2d) {
...
//		
//		/** Create drum body. */
//		//drumbody.add(new Rectangle(X, Y, Width, Height, Stroke, Color)
//		drumbody.add(new Rectangle(x, y, 300, 240, 0, Color.BLACK));				// base drum case
//		drumbody.add(new Rectangle(x-(150/2), y+10, 150, 230, 0, Color.DARK_GRAY));	// lighted side
//		drumbody.add(new Rectangle(x, 30,  310, 20, 0, Colors.SILVER));				// edge linings
//		drumbody.add(new Rectangle(x, 270, 310, 20, 0, Colors.SILVER));
//		drumbody.add(new Rectangle(x, 150, 50,  30, 0, Colors.SILVER));				// mid-holder
//		
